...
const defaultHeartImages = Array.from({ length: 255 }, (_, i) => `images/img${i + 1}.jpg`);
...
const ringTexts = [
  'UNIT KEGIATAN MAHASISWA JEPANG',//untuk deskripsi planet layer 1
  "KELUARGA BESAR MAHASISWA",//untuk deskripsi planet layer 2
  "POLITEKNIK NEGERI BALI",//untuk deskripsi planet layer 3
  ...
  for (let i = 0; i < numRings; i++) {
    ...
    function getCharType(char) {
      ...
      if ((charCode >= 0x4E00 && charCode <= 0x9FFF) || // CJK
        ...
        (charCode >= 0xAC00 && charCode <= 0xD7AF)) { // Kanji
        return 'cjk';
